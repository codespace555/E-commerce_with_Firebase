    ...
    <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
      ...
      <TabPanel>
        <div className="  px-4 md:px-0 mb-16">
          <h1
            className=" text-center mb-5 text-3xl font-semibold underline dark:text-gray-200"
          ...
          <div className="relative overflow-x-auto ">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
              <thead
                className="text-xs border border-gray-600 text-black uppercase bg-gray-200 shadow-[inset_0_0_8px_rgba(0,0,0,0.6)] dark:text-gray-200 dark:bg-[#2e4137]"
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className=" flex gap-2">
                      <div
                        className=" flex gap-2 cursor-pointer text-black dark:text-gray-200 "
      ...
      <TabPanel>
        ...
        <div className="relative overflow-x-auto mb-16 ">
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 dark:bg-[#2e3137]">
            <thead
              className="text-xs text-black uppercase bg-gray-200 dark:bg-[#2e4137]"
